...
function currentDiv(n) {
  ...
  function showDivs(n) {
    ...
    var dots = document.getElementsByClassName("gallery__section--photos");
    ...
    for (i = 0; i < dots.length; i++) {
      dots[i].className = dots[i].className.replace(" gallery__section--opacity-off", "");
    }
    x[slideIndex-1].style.display = "block";
    dots[slideIndex-1].className += " gallery__section--opacity-off";
  }